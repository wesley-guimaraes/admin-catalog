...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String expectedName = """
                 Caros amigos, a mobilidade dos capitais internacionais afeta positivamente a correta previsão das regras
                  de conduta normativas. O incentivo ao avanço tecnológico, assim como a complexidade dos estudos 
                  efetuados oferece uma interessante oportunidade para verificação do processo de comunicação como um 
                  todo. Assim mesmo, a hegemonia do ambiente político desafia a capacidade de equalização do sistema de 
                  participação geral. Por conseguinte, a estrutura atual da organização talvez venha a ressaltar a relatividade
